<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows >= 1) {
      ...
      // echo '<script>';
      // echo 'document.getElementById("error").innerHTML = "Sorry, please check your username and password";';
      // echo 'setTimeout(function(){ window.location.href = "maintenance.php"; }, 3000);';
      // echo '</script>';
  }
      ...
      $('#login-form').submit(function (e) {
        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            if(output == true)
            {
              window.location.href="maintenance-homepage.html";
            }
