  ...
  <div class="backgroundimg-home">
    <header>
      <nav class="home-nav">
        ...
        <h1 class="welcome-msg">Hello <span class="user-name"></span></h1>
        <a class="nav-link">
          <img class="profile-icon" src="images/logo/User-profile-logo.png" alt="3d-user-icon"></a>
        <div class="nav-hover">
          <a class="list-link" href="user-profile-update.html">
